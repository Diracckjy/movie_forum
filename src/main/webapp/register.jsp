...
<div class="layui-container" style="margin-top:7% ;margin-left: 25%">
    ...
    <form class="layui-form  layui-form-pane" method="post" action="${ctx}/userRegister">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="password" required  lay-verify="required" placeholder="请输入头像" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="picture" required  lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
            </div>
        </div>
